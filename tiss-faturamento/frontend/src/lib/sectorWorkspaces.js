export const SECTOR_WORKSPACES = [
  ...
  { id: 'assistencial', name: 'Assistência clínica', shortName: 'Assistencial', description: 'Atendimento, internação, prescrição e prontuário', color: 'emerald', items: ['dashboard','pacientes','atendimentos','pronto-atendimento','operacao-hospitalar','prescricao-enfermagem'] },
