export const SECTOR_WORKSPACES = [
  ...
  { id: 'recepcao', name: 'Recepção e agenda', shortName: 'Recepção', description: 'Jornada do paciente, agenda e filas', color: 'cyan', items: ['dashboard','pacientes','agendamentos','ocupacao','atendimentos','pronto-atendimento','chamados','chamados-painel'] },
  { id: 'assistencial', name: 'Assistência clínica', shortName: 'Assistencial', description: 'Atendimento, internação, prescrição e prontuário', color: 'emerald', items: ['dashboard','pacientes','atendimentos','pronto-atendimento','operacao-hospitalar','prescricao-enfermagem','apoio-diagnostico','centro-cirurgico'] },
  { id: 'diagnostico', name: 'Laboratório e imagem', shortName: 'Diagnóstico', description: 'Solicitações, coleta, processamento e resultados', color: 'violet', items: ['dashboard','pacientes','apoio-diagnostico','atendimentos','pronto-atendimento'] },
