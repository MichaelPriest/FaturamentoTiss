  ...
  return (
    <div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          <button 
            ...
            className={`px-3 py-1.5 rounded-lg text-sm transition-all duration-200 ${!convenioSelecionado ? 'bg-gradient-to-r from-blue-500 to-indigo-600 text-white shadow-md' : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600'}`}
          >
            Tabela Padrão
          </button>
          {convenios.map(c => (
            <button 
              ...
              className={`px-3 py-1.5 rounded-lg text-sm transition-all duration-200 ${convenioSelecionado?.id === c.id ? 'bg-gradient-to-r from-blue-500 to-indigo-600 text-white shadow-md' : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600'}`}
            >
              {c.razao_social}
            </button>
          ))}
      ...
      <div className="flex gap-2 mb-4 border-b border-gray-200 dark:border-gray-700">
        <button 
          onClick={() => setAba('tuss')} 
          className={`px-4 py-2 text-sm font-medium transition-all duration-200 ${aba === 'tuss' ? 'border-b-2 border-blue-600 text-blue-600 dark:text-blue-400' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'}`}
        >
          TUSS
        </button>
        <button 
          onClick={() => setAba('cbhpm')} 
          className={`px-4 py-2 text-sm font-medium transition-all duration-200 ${aba === 'cbhpm' ? 'border-b-2 border-blue-600 text-blue-600 dark:text-blue-400' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'}`}
        >
          CBHPM
        </button>
        <button 
          onClick={() => setAba('propria')} 
          className={`px-4 py-2 text-sm font-medium transition-all duration-200 ${aba === 'propria' ? 'border-b-2 border-blue-600 text-blue-600 dark:text-blue-400' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'}`}
        >
          Tabela Própria
        </button>
      </div>
                  ...
                  <tr key={p.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <span className={`inline-flex px-2 py-1 rounded-full text-xs font-medium ${
                        p.tipo === 'CONSULTA' ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400' :
                        p.tipo === 'EXAME' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' :
                    ...
                    <td className="px-4 py-3 text-sm text-gray-400 dark:text-gray-500">R$ {valorPadrao.toFixed(2)}</td>
              ...
              <form onSubmit={handleSubmit}>
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input 
                      type="text" 
                      placeholder="Grupo do procedimento" 
                ...
                <div className="flex justify-end gap-3 mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  >
                    {editing ? 'Atualizar' : 'Salvar'} Procedimento
                  </button>
                </div>
              </form>
            </div>
